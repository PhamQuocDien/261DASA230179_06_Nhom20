...
public:
    ...
    Loan* findByMemberAndBook(const std::string& memberId, const std::string& bookId);
    const Loan* findByMemberAndBook(const std::string& memberId, const std::string& bookId) const;
